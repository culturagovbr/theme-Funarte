...
$this->breadcrumb = [
    ...
    ['label' => i::__('Agenda'), 'url' => $app->createUrl('events')],
];
?>

<search page-title="<?php i::esc_attr_e('Agenda') ?>" entity-type="event"
    ...
    <template #default="{pseudoQuery, changeTab}">
        <events-stats-cards :pseudo-query="pseudoQuery"></events-stats-cards>
