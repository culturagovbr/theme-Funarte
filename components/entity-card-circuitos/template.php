...
<div class="entity-card" :class="classes">
	...
	<div class="entity-card__content">
    	<div v-if="entity.startsOn || entity.endsOn" class="circuit-dates">
            <label class="circuit-dates__title">
                <?= i::_e('Período') ?>:
            </label>
        ...
        <div v-if="seals" class="seals">
            ...
            <ul class="seals__list">
                <li v-for="seal in entity.seals" class="seals__item">
                    ...
                    <img v-else-if="seal.avatar?.avatarSmall"
                         ...
                         :alt="seal.name"
                         class="seals__image" />
                    <mc-icon v-else name="seal" class="seals__icon"></mc-icon>
                    <span class="seals__name">{{ seal.name }}</span>
                </li>
            </ul>
        </div>
