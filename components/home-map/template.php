...
<div v-if="(true) && (global.enabledEntities.events)" class="home-map">
    <div class="home-map__header">
        <label class="title"><?= $this->text('title', i::__('Encontre eventos e espaços artísticos perto de você')) ?></label>
        <label class="description"><?= $this->text('description', i::__('Conheça a programação artística da sua região e o que está acontecendo nos arredores. Utilize o mapa para localizar eventos e espaços artísticos do seu interesse.')) ?></label>
    </div>
